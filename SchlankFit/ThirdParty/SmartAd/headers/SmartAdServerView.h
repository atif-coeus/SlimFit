...
#define kSASSDKVersion						@"4.2"
#define kSASSDKRev                          @"3439363737"

#define SAS_SDK_NAME						kSASSDKName
#define SAS_SDK_VERSION						kSASSDKVersion
...
@class SmartAdServerAd, SASRequestManager, SASORMMAController, SASLoaderView, SASMoviePlayerManager, SASMRAIDBridge, SASAdViewController, SASVideoController;
...
/** The animations used to dismiss the ad view.
 ...
 A block object containing the changes to commit to the views. This is where you programmatically change any animable properties of the views in your view hierarchy. This block takes no parameters and has no return value.
