...
@property (assign, getter = isPortraitCreativeLoaded) BOOL portraitCreativeLoaded;
@property (assign, getter = isLandscapeCreativeLoaded) BOOL landscapeCreativeLoaded;
