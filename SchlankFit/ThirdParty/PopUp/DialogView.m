...
//  modaltest
//
//  Created by Ahsan Ali on 4/15/12.
...
//    }
	...
	if (!window) {
		...
		window = [(application.windows) lastObject];
	}
    
//    [[self.window subviews] enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
//        
//        NSLog(@"++%@+++",obj);
//    }];
    //================================================================
    ...
    if ([window subviews].count > 0 ) {
        frame = ((UIView*)[[window subviews] objectAtIndex:0]).frame;
    }
    else{
        frame  = window.frame;
    }
